...
public class ${user_store_name}AbstractUserStoreManager extends AbstractUserStoreManager {

    private static final Log log = LogFactory.getLog(${user_store_name}AbstractUserStoreManager.class);

    public ${user_store_name}AbstractUserStoreManager() {
    }

    public ${user_store_name}AbstractUserStoreManager(RealmConfiguration realmConfig, Map<String, Object> properties,
            ClaimManager claimManager, ProfileConfigurationManager profileManager, UserRealm realm, Integer tenantId)
            throws UserStoreException {
        super(realmConfig, properties, claimManager, profileManager, realm, tenantId);
        log.info("${user_store_name}AbstractUserStoreManager initialized...");
    }
