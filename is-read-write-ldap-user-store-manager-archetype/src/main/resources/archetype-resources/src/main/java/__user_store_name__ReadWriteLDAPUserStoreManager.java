...
public class ${user_store_name}ReadWriteLDAPUserStoreManager extends ReadWriteLDAPUserStoreManager {

    private static final Log log = LogFactory.getLog(${user_store_name}ReadWriteLDAPUserStoreManager.class);

    public ${user_store_name}ReadWriteLDAPUserStoreManager() {
    }

    public ${user_store_name}ReadWriteLDAPUserStoreManager(RealmConfiguration realmConfig, Map<String, Object> properties,
            ClaimManager claimManager, ProfileConfigurationManager profileManager, UserRealm realm, Integer tenantId)
            throws UserStoreException {
        super(realmConfig, properties, claimManager, profileManager, realm, tenantId);
        log.info("${user_store_name}ReadWriteLDAPUserStoreManager initialized...");
    }
