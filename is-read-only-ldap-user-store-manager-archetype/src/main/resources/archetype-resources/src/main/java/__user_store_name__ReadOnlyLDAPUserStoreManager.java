...
public class ${user_store_name}ReadOnlyLDAPUserStoreManager extends ReadOnlyLDAPUserStoreManager {

    private static final Log log = LogFactory.getLog(${user_store_name}ReadOnlyLDAPUserStoreManager.class);

    public ${user_store_name}ReadOnlyLDAPUserStoreManager() {
    }

    public ${user_store_name}ReadOnlyLDAPUserStoreManager(RealmConfiguration realmConfig, Map<String, Object> properties,
            ClaimManager claimManager, ProfileConfigurationManager profileManager, UserRealm realm, Integer tenantId)
            throws UserStoreException {
        super(realmConfig, properties, claimManager, profileManager, realm, tenantId);
        log.info("${user_store_name}ReadOnlyLDAPUserStoreManager initialized...");
    }
