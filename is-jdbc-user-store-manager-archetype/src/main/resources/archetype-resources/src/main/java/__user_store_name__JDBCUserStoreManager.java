...
public class ${user_store_name}JDBCUserStoreManager extends JDBCUserStoreManager {

    private static final Log log = LogFactory.getLog(${user_store_name}JDBCUserStoreManager.class);

    public ${user_store_name}JDBCUserStoreManager() {
    }

    public ${user_store_name}JDBCUserStoreManager(RealmConfiguration realmConfig, Map<String, Object> properties,
            ClaimManager claimManager, ProfileConfigurationManager profileManager, UserRealm realm, Integer tenantId)
            throws UserStoreException {
        super(realmConfig, properties, claimManager, profileManager, realm, tenantId);
        log.info("${user_store_name}JDBCUserStoreManager initialized...");
    }
